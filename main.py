...
def main():
    ...
    #Now we will defines the length of the backlog queue( e.g. 1 in our case 1)
    ...
    serverSocket.listen(1)#In the socket, server listen to connection request from clients
    # Fill in end
